...
function Item:show_item()
    ...
    if new.rank ~= nil then
        start = string.format("%s %s | ", util.title(self.data.type), new.rank:upper())
...
function Item:is_speed_true_damage()
    if self.data.equip.speed_true_damage then
        return self.data.equip.speed_true_damage
...
function Item:is_magic_true_damage()
    if self.data.equip.magic_true_damage then
        return self.data.equip.magic_true_damage
